...
namespace ThaiAirways.Model
{
    public class FlighSearchModel
    {
        ...
        public async System.Threading.Tasks.Task<FlightSearchContent> GetFlight(int AdultsCount, int ChildrenCount, int InfantCount, string CabinClass, string DepartureDate, string DepartFrom, int MaxStops, string ReturnDate, string DepartTo, string lang, string currency)
        {
            ...
            {
                content = JsonConvert.DeserializeObject<ThaiAirways.Model.FlightSearchContent>(response.Content);
            }

            return content;
        }

        public List<FlightSearchEntity> GetFlightDetails(int AdultsCount, int ChildrenCount, int InfantCount, string CabinClass, string DepartureDate, string DepartFrom, int MaxStops, string ReturnDate, string DepartTo, string lang, string currency)
        {
